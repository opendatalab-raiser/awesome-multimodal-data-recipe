...
- **📄 TextSSR** [(arXiv 2505.20275)](https://arxiv.org/abs/2505.20275) 🏷️ **[方法 + 数据]** - **ICCV 2025**
...
- **📄 ImgEdit** [(arXiv 2502.57501)](https://arxiv.org/abs/2502.57501) 🏷️ **[方法 + 数据 + 基准]**
...
| **ImgEdit** | 120万三元组<br/>（95万单轮 + 25万多轮） | 统一编辑 | **统一图像编辑数据集**：8大编辑类别（对象添加/删除/替换、属性修改、背景变化、风格迁移、空间重排、多对象编辑）；多轮编辑配身份一致性；配ImgEdit-Bench（1K测试样本） | [📄 论文](https://arxiv.org/abs/2502.57501) \| 参见[方法栏](#-图像编辑方法数据) |
